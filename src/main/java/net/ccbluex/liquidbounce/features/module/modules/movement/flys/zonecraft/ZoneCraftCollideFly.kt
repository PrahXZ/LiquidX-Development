...
class ZoneCraftCollideFly: FlyMode("ZoneCraftCollide") {
    ...
    override fun onUpdate(event: UpdateEvent) {
        ...
        if((LiquidBounce.moduleManager[OldKillAura::class.java]!!.target == null || LiquidBounce.moduleManager[OldKillAura::class.java]!!.target == null) && !mc.thePlayer.isBlocking) {
