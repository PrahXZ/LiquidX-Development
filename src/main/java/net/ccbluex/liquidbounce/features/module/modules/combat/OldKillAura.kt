...
@ModuleInfo(name = "OldKillAura", category = ModuleCategory.COMBAT)
class OldKillAura : Module() {
    ...
    private val spinHurtTimeValue = IntegerValue("Spin-HitHurtTime", 10, 0, 10).displayable { rotations.equals("Spin") }
    ...
    private val vulcanautoblock = BoolValue("VulcanAutoblock", true).displayable { !autoBlockModeValue.equals("None") && displayAutoBlockSettings.get() }
   ...
   fun onPacket (event: PacketEvent) {
        ...
        if (!autoBlockModeValue.equals("None") && vulcanautoblock.get()){
