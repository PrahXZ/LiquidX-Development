...
package net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.CSGO;

import net.ccbluex.liquidbounce.LiquidBounce;
import net.ccbluex.liquidbounce.features.module.Module;
import net.ccbluex.liquidbounce.features.module.ModuleCategory;
import net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.CSGO.LightSettings.InputBox;
import net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.CSGO.ModuleSettings.Settings;
...
public class LightClickGUI extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtils.drawImage(new ResourceLocation( "liquidx/ui/clickgui/hud.png"), 9, height - 41, 32, 32);
        ...
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/Combat.png"), (int) startX + 17, (int) startY + 35, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/Movement.png"), (int) startX + 17, (int) startY + 70, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/World.png"), (int) startX + 17, (int) startY + 105, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/Player.png"), (int) startX + 17, (int) startY + 140, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/Exploit.png"), (int) startX + 17, (int) startY + 175, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/Misc.png"), (int) startX + 17, (int) startY + 210, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/Client.png"), (int) startX + 17, (int) startY + 245, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/csgoui/Render.png"), (int) startX + 17, (int) startY + 280, 12, 12);
