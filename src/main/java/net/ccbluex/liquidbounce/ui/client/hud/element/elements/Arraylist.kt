...
class Arraylist(
    ...
    private val colorRedValue = IntegerValue("Text-R", 126, 0, 255)
    private val colorGreenValue = IntegerValue("Text-G", 51, 0, 255)
    private val colorBlueValue = IntegerValue("Text-B", 0, 0, 255)
    ...
    private val rectColorRedValue = IntegerValue("Rect-R", 126, 0, 255)
    private val rectColorGreenValue = IntegerValue("Rect-G", 51, 0, 255)
    private val rectColorBlueValue = IntegerValue("Rect-B", 0, 0, 255)
                    ...
                    ShadowUtils.shadow(shadowStrength.get().toFloat(), {
                        ...
                        modules.forEachIndexed { index, module ->
                            ...
                            RenderUtils.newDrawRect(
                                    xPos.toDouble() - if (rectValue.equals("Right")) 3 else 2,
                                    arrayY,
                                    if (rectValue.equals("Right")) -1.toDouble() else 0.toDouble(),
